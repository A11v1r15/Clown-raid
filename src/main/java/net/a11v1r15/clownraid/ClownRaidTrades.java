        ...
        copyToFastUtilMap(ImmutableMap.of(
            ...
            3, //The Funny, multiple of them for chance
                new TradeOffers.Factory[]{
                        ...
                        new SellForCurrencyItemFactory(getItem("honque:the_green_funny"), getItem("terrifictickets:token"), 64, 1, 1, 3),
                        new SellForCurrencyItemFactory(getItem("honque:the_blue_funny"), getItem("terrifictickets:token"), 64, 1, 1, 3),
                        new SellForCurrencyItemFactory(getItem("honque:the_funny"), getItem("terrifictickets:token"), 64, 1, 1, 3),
