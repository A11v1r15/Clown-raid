...
public class ClownEntityModel<T extends ClownEntity> extends VillagerResemblingModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData jacket = 	body.addChild(EntityModelPartNames.JACKET, ModelPartBuilder.create().uv(0, 38).cuboid(-4.0F, -24.0F, -3.0F, 8.0F, 13.0F, 6.0F, new Dilation(0.5F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
        ModelPartData right_leg = body.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(0, 22).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new Dilation(0.0F))
                .uv(40, 53).cuboid(-2.0F, 9.0F, -6.0F, 4.0F, 3.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, -12.0F, 0.0F));
        ModelPartData left_leg = body.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 22).mirrored().cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
