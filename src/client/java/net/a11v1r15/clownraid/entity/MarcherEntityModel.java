...
public class MarcherEntityModel<T extends MarcherEntity> extends VillagerResemblingModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hat_rim = hat.addChild(EntityModelPartNames.HAT_RIM, ModelPartBuilder.create().uv(46, 53).cuboid(-4.0F, -4.0F, -6.0F, 8.0F, 10.0F, 1.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));        
